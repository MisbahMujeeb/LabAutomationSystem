...
if(isset($_POST['submit'])){
    ...
    $sql=mysqli_query($con,"INSERT into contact(Name,email,mobile,added_on,comment) values ('$uName','$uEmail,$uName',$uNumber,'$uDate',\"$uMessage\")");
    if($sql){
    }else{
       return;
    }
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group ">
                                        <input class="form-control" name="email" id="email" required="" placeholder="Enter Email" type="email">
                                    </div>
                                </div>
                            </div>
                            <!-- End Input -->
                            ...
                            <div class="col-sm-6 mb-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                     <input class="form-control" name="date"  required="" placeholder="Select Date" type="date"> 
