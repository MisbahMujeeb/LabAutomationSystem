...
<head>
  ...
  <!-- Animate Css -->
  <link rel="stylesheet" href="userPlugins/animate-css/animate.css">
  <!-- Icon Font css -->
  <link rel="stylesheet" href="userPlugins/fontawesome/css/all.css">
  <link rel="stylesheet" href="userPlugins/fonts/Pe-icon-7-stroke.css">
  <!-- Themify icon Css -->
  <link rel="stylesheet" href="userPlugins/themify/css/themify-icons.css">
  <!-- Slick Carousel CSS -->
  <link rel="stylesheet" href="userPlugins/slick-carousel/slick/slick.css">
  <link rel="stylesheet" href="userPlugins/slick-carousel/slick/slick-theme.css">
            ...
            <div class="row">
                <div class="col-lg-2">
                    <div class="logo d-none d-lg-block">
                        <!-- Brand -->
                        <a class="navbar-brand js-scroll-trigger" href="index.php" ><img src="images/log.png" alt="Logo" width="350px">
                        </a>
                    </div>
                </div>
                 ...
                 <div class="col-lg-8 justify-content-end ml-lg-auto d-flex col-12">
                    ...
                    <div class="top-info-block d-inline-flex">
                        ...
                        <div class="info-block">
                            <h5 class="font-weight-500">abc@gmail.com</h5>
                            <p>Email Us</p>
                        </div>
                    </div>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark bg-primary main-nav navbar-togglable rounded-radius">
                ...
                <a class="navbar-brand d-lg-none d-block" href="">
                    <h4>SRS Electronic Appliances</h4>
                </a>
                <!-- Toggler -->
